...
async function insert(dog: DogDocument) {
  ...
  if (result.insertedCount === 1) {
    ...
    // mappedResult = { _id: ObjectID(<generated>), name: 'None', likesPizza: true } as DogDocument
  }
}
